...
<YYINITIAL>{
    ...
    {TwoLAng}                     {return symbol(sym.TWOLANG);}

    {TwoRAng}                     {return symbol(sym.TWORANG);}

    {ThreeRAng}                     {return symbol(sym.THREERANG);}
    ...
    {TwoLAngEq}                   {return symbol(sym.TWOLANGEQ);}

    {TwoRAngEq}                   {return symbol(sym.TWORANGEQ);}

    {ThreeRAngEq}                   {return symbol(sym.THREERANGEQ);}
